...
public class SwitchView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(isOn ? 0xff9fd6ae : 0xfff0f0f0);
	...
	private SwitchStateChanged stateChanged;

	public interface SwitchStateChanged {
		void state(boolean result);
	}

	public void setOnSwithState(SwitchStateChanged stateChanged) {
