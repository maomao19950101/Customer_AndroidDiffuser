...
public class AppConstant {
    ...
    public class HardwareCommands {
        ...
        public static final String CMD_RGB_OFF="BA0F0000000FFFEE0D0A";//add 2017-03-27 JET
        public static final String CMD_RGB_ON="BA0F9999990FFFEE0D0A";//add 2017-03-27 JET
...
//        public static final String CMD_START_END_TIME="BA07HHMMHHMMFFEE0D0A";//hhmm starttime, hhmm endtime
	...
	public static List<VideoInfoConfig> getConfigList() {
        ...
        config.setRgb1("188CEE");
        config.setRgb2("6DBBFF");
        config.setRgb3("188CCC");
        config.setRgbModel(1);
        listConfig.add(config);
       
        config = new VideoInfoConfig();//mountain_lake1000
        config.setMistTime(1);
        config.setRgb1("00EE30");
        config.setRgb2("00FF40");
        config.setRgb3("188AAA");
        config.setRgbModel(2);
        listConfig.add(config);
        
        config = new VideoInfoConfig();//rain_on_leave1000
        config.setMistTime(1);
        config.setRgb1("6CAAAA");
        ...
        config.setMistTime(1);
        config.setRgb1("FFD445");
        config.setRgb2("FF632B");
        ...
        config.setMistTime(1);
        config.setRgb1("000885");
        config.setRgb2("000347");
        config.setRgb3("350055");
        config.setRgbModel(1);
        listConfig.add(config);
        
        config = new VideoInfoConfig();//woodland_lake1000
        config.setMistTime(2);
        config.setRgb1("FF7D00");
        config.setRgb2("E55488");
        config.setRgb3("570500");
        config.setRgbModel(2);
        listConfig.add(config);
        
        config = new VideoInfoConfig();//oo_fireplace
        config.setMistTime(1);
        config.setRgb1("FF6C00");
        config.setRgb2("FF4400");
        config.setRgb3("FF2500");
        config.setRgbModel(1);
        listConfig.add(config);
       
      /*  config = new VideoInfoConfig();//oo_moving_cloudbreak
        config.setMistTime(2);
        config.setRgb1("FF6C00");
        config.setRgb2("FF632B");
        config.setRgb3("FF2500");
